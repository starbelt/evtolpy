...
json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../example aircraft/NASA_QR.json'))
...
reference_values = {
    "PTOW (kg)": 2939.3,
    "CTOW (kg)": 2939.3,
    "Hover power (kW)": 501.1,
    "Cruise power (kW)": 250.7,
    "Battery weight (kg)": 710.8,
    "Cruise L/D": 5.8,
}
