...
json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'NASA_TR.json'))
...
reference_values = {
    ...
    'SYSTEM & EQUIP (kg)': 1042.2 * LBS_TO_KG,
}
...
sized_values = {
    ...
    'SYSTEM & EQUIP (kg)': sum(subsystems.values()),
}
