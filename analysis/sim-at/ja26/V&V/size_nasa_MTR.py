...
json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../example aircraft/NASA_MTR.json'))
...
print(f"{'Metric':<22s} {'Sized':>12s} {'Ref':>12s} {'% Diff':>10s}")
print("-" * 60)
...
# Reference values
ref_lb = {
    'Design Gross Weight': 6355.0,
    'Weight Empty':        3874.72,
}
