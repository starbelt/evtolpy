...
mission_segment_values = [\
 ...
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.hover_climb_energy_kw_hr),
 ...
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.decel_descend_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.arrive_proc_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.trans_descend_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.hover_descend_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.arrive_taxi_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_hover_climb_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_trans_climb_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_accel_climb_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_cruise_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_decel_descend_kw_hr),
 '{:.6f}'.format(0.0), # '{:.6f}'.format(aircraft.reserve_trans_descend_kw_hr),
 '{:.6f}'.format(0.0)  # '{:.6f}'.format(aircraft.reserve_hover_descend_kw_hr),
]
