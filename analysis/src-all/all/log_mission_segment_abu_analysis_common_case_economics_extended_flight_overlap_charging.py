# log_mission_segment_abu_analysis_common_case_economics_extended_flight_overlap_charging.py
#
# Usage: python3 log_mission_segment_abu_analysis_common_case_economics_extended_flight_overlap_charging.py /path/to/cfg.json /path/to/log/
...
#
# Output:
#  mission-segment-abu-analysis-common-case-economics-extended-flight-overlap-charging.csv
#
# Written by 
...
if len(sys.argv) == 3:
  ...
  print(
    'Usage: '
    'python3 log_mission_segment_abu_analysis_common_case_economics_extended_flight_overlap_charging.py '
...
t_cruise_abu_return_hr  = 0.025      # cruise-assisted ABU returning to base time [hr]
...
results = aircraft._evaluate_common_case_abu_extended_flight_overlap_charging(
...
output_csv = os.path.join(log, 'mission-segment-abu-analysis-common-case-economics-extended-flight-overlap-charging.csv')
