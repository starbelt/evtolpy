# log_mission_segment_abu_analysis_common_case_economics_combined_overlap_charging.py
#
# Usage: python3 log_mission_segment_abu_analysis_common_case_economics_combined_overlap_charging.py /path/to/cfg.json /path/to/log/
...
#
# Output:
#  mission-segment-abu-analysis-common-case-economics-combined-overlap-charging.csv
#
# Written by 
...
if len(sys.argv) == 3:
  ...
  print(
    'Usage: '
    'python3 log_mission_segment_abu_analysis_common_case_economics_combined_overlap_charging.py '
...
t_takeoff_abu_return_hr = 0.025        # ABU (takeoff) return-to-base delay [hr]
t_cruise_abu_return_hr  = 0.025        # ABU (cruise) return-to-base delay [hr]
...
results = aircraft._evaluate_common_case_abu_combined_overlap_charging(
...
output_csv = os.path.join(log, 'mission-segment-abu-analysis-common-case-economics-combined-overlap-charging.csv')
...
fieldnames = [
  ...
  "dod_abu_cruise",
  "t_flight_hr",
  "t_overlap_hr_takeoff_abu",
  "t_overlap_hr_cruise_abu",
  "t_charge_hr_main",
  "t_charge_hr_takeoff_abu_raw",
  "t_charge_hr_cruise_abu_raw",
  "t_charge_hr_takeoff_abu_net",
  "t_charge_hr_cruise_abu_net",
  "t_charge_hr_total",
  "t_ground_ops_hr",
  "t_takeoff_abu_return_hr",
  "t_cruise_abu_return_hr",
  "t_cycle_hr",
  "n_feasible_flights",
  "t_flight_day_hr",
  "t_downtime_day_hr",
