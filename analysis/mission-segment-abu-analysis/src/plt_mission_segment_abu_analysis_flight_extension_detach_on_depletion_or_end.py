# plt_mission_segment_abu_analysis_flight_extension_detach_on_depletion_or_end.py
#
# Usage: python3 plt_mission_segment_abu_analysis_flight_extension_detach_on_depletion_or_end.py /path/to/log.csv /path/to/plt/
...
if len(sys.argv)==3:
  ...
  print(\
   'Usage: '\
   'python3 plt_mission_segment_abu_analysis_flight_extension_detach_on_depletion_or_end.py '\
